...
COACH_LINES = {
    "send_reminder": "Hey, you have been on your phone a while. Time for a break?",
    "block_app":     "That is enough. Locking distractions for you right now.",
    "encourage":     "You are doing brilliant. Keep that streak alive!",
    "do_nothing":    "You are managing yourself well. Staying out of your way.",
}
...
def _build_chart():
    ...
    fig.add_trace(go.Scatter(x=steps, y=[s/12 for s in screens], name="Screen Time (div 12)",

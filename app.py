...
Gradio   ->  /       root             (Visual UI — shows on HF Space homepage)
"""
...
# ──────────────────────────────────────────────────────────────────────────────
# FastAPI — OpenEnv validator endpoints
# ──────────────────────────────────────────────────────────────────────────────
...
ACTION_META = {
    "send_reminder": {"emoji": "⏰", "color": "#f59e0b"},
    "block_app":     {"emoji": "🚫", "color": "#ef4444"},
    "encourage":     {"emoji": "💪", "color": "#10b981"},
    "do_nothing":    {"emoji": "😌", "color": "#6366f1"},
}
COACH_LINES = {
...
# ──────────────────────────────────────────────────────────────────────────────
# Mount Gradio at ROOT so it shows on the HF Space homepage
